...
export function AdminLoginForm({
  ...
  return (
    <form
      action={action}
      className="industrial-border mx-auto mt-10 grid max-w-md gap-4 bg-comun-paper p-5 text-comun-black"
    >
      <h1 className="text-2xl font-black uppercase">Admin COMUN</h1>
      <p className="text-sm text-comun-asphalt/75">
        Area interna para curadoria. Entre com o usuario cadastrado no Supabase
        Auth.
      </p>
