...
export function AdminLoginForm() {
  ...
  return (
    <form action={action} className="industrial-border mx-auto mt-10 grid max-w-md gap-4 bg-comun-paper p-5 text-comun-black">
      ...
      <p className="text-sm text-comun-asphalt/75">Area interna para curadoria. Use a senha configurada em COMUN_ADMIN_PASSWORD.</p>
      ...
      <label className="grid gap-2">
        ...
        <input name="password" type="password" className="min-h-12 border-2 border-comun-black bg-white px-3" />
      </label>
