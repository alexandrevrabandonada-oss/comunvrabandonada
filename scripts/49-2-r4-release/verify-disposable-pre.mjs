...
if (!productionPath || !disposablePath)
  throw new Error("COMUN_R4_PRE_INPUT_MISSING");
const production = JSON.parse(readFileSync(productionPath, "utf8"));
const disposable = JSON.parse(readFileSync(disposablePath, "utf8"));
if (
  production.scope !== "COMUN_49_2_R4_PRODUCTION_PRE_READ_ONLY" ||
  production.transactionReadOnly !== "on" ||
  production.r1Present !== true ||
  production.r2Present !== true ||
  production.r3Present !== true ||
  production.r4Present !== false ||
  production.r12Ledger !== "PRESENT_ACCEPTED" ||
  production.r3Ledger !== "PRESENT_ACCEPTED" ||
  production.hardeningLedger !== "PRESENT_ACCEPTED" ||
  production.r4LedgerState !== "ABSENT" ||
  production.blockingFindings !== 0 ||
  ...
  throw new Error("COMUN_49_2_R4_DISPOSABLE_PRE_DRIFT");
console.log("COMUN_49_2_R4_DISPOSABLE_PRE_MATCHES_PRODUCTION");
