...
export function classifyR3Release(capture, manifest, baseline) {
  ...
  const pre =
    ...
    capture.r3Present === false &&
    capture.candidateTablePresent === false &&
    capture.candidateBridgePresent === false &&
    capture.r3TriggerCount === 0 &&
  ...
  const postSchema =
    ...
    capture.canonicalFingerprint ===
      manifest.expectedPostCanonicalFingerprint &&
    capture.r3Present === true &&
