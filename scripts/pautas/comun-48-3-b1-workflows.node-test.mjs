...
const preflight = readFileSync(
  ".github/workflows/comun-48-3-b1-preflight.yml",
  "utf8",
);
const disposable = readFileSync(
  ".github/workflows/comun-48-3-b1-disposable.yml",
  "utf8",
);
const activation = readFileSync(
  ".github/workflows/comun-48-3-b1-activation.yml",
  "utf8",
);
const wave = readFileSync(
  "scripts/pautas/run-48-3-b1-production-wave.sh",
  "utf8",
);
