...
test("canonical workflows remain active and known additions are explicit", () => {
  ...
  const knownAdditional = new Set([
    ...
    "comun-49-2-a0-r3-private-candidate-disposable.yml",
    "comun-49-2-partial-r1-canonical-diagnostic.yml",
    "comun-49-2-private-schema-diagnostic.yml",
    "comun-49-2-private-schema-promotion.yml",
    "comun-49-2-private-schema-recovery-proof.yml",
    "comun-49-2-private-schema-recovery.yml",
    "comun-49-2-schema-grant-diagnostic.yml",
    "comun-49-2-private-release-pre-capture.yml",
    "comun-49-2-private-release-disposable.yml",
    "comun-49-2-r3-private-schema-promotion.yml",
    "comun-49-2-r3-production-pre-capture.yml",
    "comun-49-2-r3-release-disposable.yml",
