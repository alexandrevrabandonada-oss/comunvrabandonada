...
export function QuickCaptureV2({ attachmentsEnabled = false, locationEnabled = false }: { attachmentsEnabled?: boolean; locationEnabled?: boolean }) {
  ...
  async function persistEvidence() {
    ...
    if (photo && attachmentsEnabled) {
      ...
      const result = await fetch(upload.upload.url, { method: upload.upload.method, headers: { "content-type": upload.upload.contentType ?? photo.type, "x-upsert": "false" }, body: photo });
