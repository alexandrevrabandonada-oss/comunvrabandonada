    ...
    <ComunShell>
      ...
      >
        ...
        {civicIntelligencePilot ? (
          <ComunSection className="py-7">
            <section
              className="border-2 border-comun-yellow p-5"
              aria-labelledby="home-civic-search"
            >
              <h2
                id="home-civic-search"
              ...
              >
                <input
                  aria-label="Necessidade ou assunto"
                  className="min-h-12 flex-1 border-2 bg-white px-3 text-comun-black"
                  name="q"
              ...
              <p className="mt-3 text-sm text-comun-paper/65">
                Exemplos: “o que aconteceu depois?”, “onde registrar uma
                calçada?” ou o título exato de uma pauta.
              </p>
            </section>
          </ComunSection>
        ) : null}
