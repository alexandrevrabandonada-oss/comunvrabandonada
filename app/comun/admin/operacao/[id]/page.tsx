...
export default async function ItemPage({
  ...
  const appV2 = isComunAppV2(resolvedSearchParams.experiencia);
  ...
  return (
    <ComunOperationalShell
      active={appV2}
      currentPathname={`/comun/admin/operacao/${id}`}
    >
      <main className="mx-auto max-w-3xl p-4 sm:p-6">
        <Link href={withComunAppV2(safeReturn, appV2)} className="underline">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          <Link
            ...
            href={withComunAppV2(sourceHref, appV2)}
          >
