...
import { moderateSidewalkObservation, moderateSidewalkRecord } from "./actions";
...
export default async function Page() {
  ...
  const [records, observations] = await Promise.all([
    db
      ...
      .select(
        "id,name,condition,categories,created_at,approximate_location,neighborhood,private_geometry_geojson,location_accuracy_m,inferred_street,inferred_neighborhood,geographic_risk,status",
      )
