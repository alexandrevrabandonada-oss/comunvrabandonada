...
export type PautaTaskStatus = "open" | "assigned" | "in_progress" | "done" | "blocked" | "cancelled" | "archived";
...
export type PautaSpace = {
  ...
  risk_level: "normal" | "attention" | "high" | "critical";
  responsible_internal: string | null;
  responsible_public: string | null;
  territory_id: string | null;
  affected_people_public: string | null;
  problem_public: string | null;
  demand_public: string | null;
  proposals_public: string | null;
  participation_public: string | null;
