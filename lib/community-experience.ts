...
const experiences: Record<string, CommunityExperience> = {
  ...
  cidade: { slug:"cidade",kind:"territorial",territory:"Bairros de Volta Redonda",themes:["mobilidade","serviços urbanos"],state:"organizing",purpose:"Organizar problemas urbanos recorrentes em pautas, ações e memória territorial.",nextAction:"Registrar um trecho de calçada por referência aproximada.",nextActivity:{title:"Mutirão de leitura das calçadas",dateLabel:"27 jul · 9h",isoDate:"2026-07-27T09:00:00-03:00"},governance:commonGovernance,collaboration:["Colaborar no território","Ajudar em ações","Participar de rodas","Contribuir com Rádio"],workingGroups:[{name:"Calçadas em circulação",objective:"Identificar barreiras e encaminhar prioridades.",cycle:"Julho–agosto de 2026",state:"em ciclo",result:"Lista territorial e memória do percurso"}],circle:{title:"Roda de prioridades urbanas",question:"Qual barreira precisa de ação primeiro?",stage:"propostas",deadline:"27 de julho",synthesis:"Evidências serão ligadas à pauta, sem comentários infinitos.",divergences:"Critérios de urgência ainda serão pactuados.",decision:"Encaminhamento publicado após a roda."}},
};
