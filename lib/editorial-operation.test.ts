...
describe("operação editorial",()=>{
 ...
 it("sanitiza recursivamente",()=>expect(sanitizeOperationalPayload({title:"x",nested:{private_contact:"a",ok:1},tokens:[{secret:"x",safe:true}]})).toEqual({title:"x",nested:{ok:1}}));
