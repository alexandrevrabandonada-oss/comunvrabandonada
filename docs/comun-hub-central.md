# COMUN como hub central

O COMUN é o sistema operacional da organização popular. Sua hierarquia pública é: Pautas, Ações, Participar, Territórios, Projetos e Acervo. Pauta é a entidade central; relatos a alimentam, evidências a sustentam, ações respondem a ela, comunicação amplia a mobilização, resultados prestam contas e o Acervo preserva a memória.
