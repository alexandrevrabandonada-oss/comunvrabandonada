...
`art_gallery` substitui o placeholder futuro e aceita `collectionIds`, `artworkIds`, `relationTypes`, `territoryIds`, `limit`, `showCreators` e `contributionEnabled`. Somente obras publicadas e relacionadas aparecem.
